...
<template>
  <div class="mb-8">
    ...
    <va-tabs>
      <va-tab label="router">
        <code-snippet :code="indexRouterSnippet" text="index.ts" />
      </va-tab>
      <va-tab label="parts">
        <code-snippet :code="routerPartSnippet" text="auth.rotes.ts" />
      </va-tab>
      <va-tab label="middleware">
        <code-snippet :code="rooterMiddlewareSnippet" text="auth.middleware.ts" />
      </va-tab>
    </va-tabs>
  </div>
</template>
